...
{
    return _mm_shuffle_epi32(_mm_srai_epi32(a, 31), _MM_SHUFFLE(3, 3, 1, 1));
}
...
inline void v_load_deinterleave(const uchar* ptr, v_uint8x16& a, v_uint8x16& b, v_uint8x16& c, v_uint8x16& d)
{
    ...
    __m128i u2 = _mm_loadu_si128((const __m128i*)(ptr + 32));
    __m128i u3 = _mm_loadu_si128((const __m128i*)(ptr + 48));
...
{
    __m128i u0 = _mm_loadu_si128((const __m128i*)ptr);
    __m128i u1 = _mm_loadu_si128((const __m128i*)(ptr + 8));
    __m128i u2 = _mm_loadu_si128((const __m128i*)(ptr + 16));
    __m128i u3 = _mm_loadu_si128((const __m128i*)(ptr + 24));
...
{
    v_uint32x4 s0(_mm_loadu_si128((const __m128i*)ptr));
    v_uint32x4 s1(_mm_loadu_si128((const __m128i*)(ptr + 4)));
    v_uint32x4 s2(_mm_loadu_si128((const __m128i*)(ptr + 8)));
    v_uint32x4 s3(_mm_loadu_si128((const __m128i*)(ptr + 12)));
                                ...
                                v_uint64x2& b, v_uint64x2& c, v_uint64x2& d)
{
    ...
    __m128i t1 = _mm_loadu_si128((const __m128i*)(ptr + 2));
    __m128i t2 = _mm_loadu_si128((const __m128i*)(ptr + 4));
    __m128i t3 = _mm_loadu_si128((const __m128i*)(ptr + 6));
...
inline v_float32x4 v_load_expand(const float16_t* ptr)
{
    ...
    __m128i bits = _mm_unpacklo_epi16(z, _mm_loadl_epi64((const __m128i*)ptr));
